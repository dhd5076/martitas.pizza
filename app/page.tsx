  ...
  return (
    <div className="max-w-screen-lg mx-auto drop-shadow-xl">
      <div className="bg-[url('/pizzabg.png')] bg-left bg-contain">
        <div className="flex items-center justify-center bg-linear-to-r from-black/0 from-10% to-olive-200 to-40%">
            <div className="flex flex-col items-center">
              <div className="flex w-full justify-end gap-8 pr-16">
                <Link href="/" className={`text-md text-olive-900 font-(family-name:--font-heading) font-black tracking-widest mt-4 mb-8`}> Home</Link>
                <Link href="/" className={`text-md text-olive-900 font-(family-name:--font-heading) font-black tracking-widest mt-4 mb-8`}> Our Story</Link>
                <Link href="/" className={`text-md text-olive-900 font-(family-name:--font-heading) font-black tracking-widest mt-4 mb-8`}> Contact Us</Link>
              </div>
      ...
      <div className="bg-right bg-contain">
        <div className="flex items-left">
            <div className="flex flex-col w-1/2 pt-4 bg-olive-200">
      ...
      <div className="bg-olive-200 flex items-center justify-center">
        <div className="w-1/4 p-2 shadow-2xl m-4 bg-olive-100  border border-olive-300  rounded-b-xl">
      ...
      <div className="bg-olive-200 items-center justify-center flex"> 
        <Image src="/linebreak.png" alt="linebreak" width={400} height={100} className="self-center -m-24"/>
      </div>
    </div>
  );
