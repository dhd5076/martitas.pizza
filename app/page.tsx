...
export default function Home() {
  return (
    <div className="max-w-screen-lg mx-auto drop-shadow-xl bg-taupe-200">
      <div className="bg-[url('/pizzabg.png')] bg-left bg-contain">
        <div className="flex items-center justify-center bg-linear-to-r from-black/0 from-10% to-taupe-200 to-40%">
            <div className="flex flex-col items-center">
              <Image  className="-mb-24 -mt-16" src="/martitaspizza.png" alt="Martita's Pizza" width={400} height={400}/>
      ...
      <div className="bg-[url('/lady2.png')] bg-bottom-right bg-contain bg-no-repeat">
        <div className="flex items-left bg-linear-to-r from-taupe-200 from-60% to-black/0 to-70%">
            <div className="flex flex-col w-1/2 pt-4 bg-gradient-to-r">
      ...
      <div>
        <h1 className="text-olive-700 text-3xl font-(family-name:--font-heading) text-center mt-16"> Our Signature Menu</h1>
  ...
  return (
    <div className="w-1/4 p-2 shadow-2xl m-4 bg-taupe-100  border border-olive-300 rounded-b-xl">
          <div className="w-full overflow-hidden">
            <img src="/pizza.png" alt="pizza" className="block w-full object-cover" />
          </div>
